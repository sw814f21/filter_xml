...
class TempFileTest(unittest.TestCase):
    ...
    def test_can_add_valid_date(self):
        self.temp_file = TempFile(
            {'navnelbnr': '1234', 'testField': 'testValue'})

        self.temp_file.add_data(
            {'navnelbnr': '4321', 'testField': 'testValue'})

    def test_get_all_correct_data(self):
        self.temp_file = TempFile(
            {'navnelbnr': '1234', 'testField': 'testValue'})
        row1 = {'navnelbnr': '123', 'testField': 'test1'}
        row2 = {'navnelbnr': '456', 'testField': 'test2'}
        row3 = {'navnelbnr': '789', 'testField': 'test3'}
    ...
    def test_exception_when_no_seq_nr_in_data_example(self):
    ...
    def test_exception_when_no_seq_nr_in_data(self):
        row1 = {'id': '123', 'field1': '321'}
        self.temp_file = TempFile({'navnelbnr': '111', 'field1': '111'})
